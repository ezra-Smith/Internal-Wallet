...
// Web3UserModel maps to web3_users table (device-based Web3 wallet users)
type Web3UserModel struct {
	ID       int64  `gorm:"column:id;primaryKey;autoIncrement"`
	DeviceID string `gorm:"column:device_id;type:varchar(128);not null;uniqueIndex"`

	Platform    string  `gorm:"column:platform;type:varchar(20);not null;default:''"`
	...
	BiometricEnabled   bool       `gorm:"column:biometric_enabled;type:tinyint(1);not null;default:0"`
	BiometricType      *string    `gorm:"column:biometric_type;type:varchar(50)"`
	HasTradePassword   bool       `gorm:"column:has_trade_password;type:tinyint(1);not null;default:0"`
...
func (Web3UserModel) TableName() string {
	return "web3_users"
}
